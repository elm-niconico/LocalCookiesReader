...
using ExtractLocalCookie.SQL.Table;
using ExtractLocalCookie.Util;

namespace ExtractLocalCookie.SQL;

public class ChromeCookieSql
{
    public List<CookieTable> SelectCookies(string cookiesPath)
    {
